(function () {
    var app = angular.module('MockModule', ['ngMockE2E']);

    app.constant('MockModule.baseUrl', 'webresources');

    app.run(['$httpBackend', 'MockModule.urls', 'MockModule.mockRecords', 'MockModule.baseUrl', function ($httpBackend, urls, mockRecords, baseUrl) {
