...
(function () {
	...
	var mainApp = angular.module('mainApp', ['ngRoute', 'facturaModule', 'compradorModule','artistaModule','estampaModule','navbarModule','carritoModule','formaPagoModule','moduloCamiseta']);
